...
const fixtures = [
	...
	['users', {id: '5d3c81b49d866268d230e180', gid: 2, firstName: 'Confused', lastName: 'User', email: 'confused@aggiegradebook.com', created_at: '2019-01-01', updated_at: '2019-01-01', isNew: 0, settings: '{}'}],
	['users', {id: '5d3c81d738773f9ae92e8c7d', gid: 3, firstName: 'Random', lastName: 'User', email: 'random@aggiegradebook.com', created_at: '2019-01-01', updated_at: '2019-01-01', isNew: 0, settings: '{}'}],
	['courses', {id: '5d3c81fbaf84df3df0a18c1b', user_id: '5d3c8150930db248a9d7514f', semester: '2019S', name: 'Course A'}],
	['courses', {id: '5d3c8227faade0e6c7e0ed30', user_id: '5d3c8150930db248a9d7514f', semester: '2019S', name: 'Course B'}],
	['courses', {id: '5d3c822b361ac86457c4395e', user_id: '5d3c8150930db248a9d7514f', semester: '2019S', name: 'Course C'}],
	['courses', {id: '5d3c8230c95745a3e0806c9b', user_id: '5d3c8150930db248a9d7514f', semester: '2019S', name: 'Course D'}],
	['courses', {id: '5d48437d8c01946f39ea997f', user_id: '5d3c8150930db248a9d7514f', semester: '2019S', name: 'Course No Grades'}],
	['categories', {id: '5d3c828ed99534fd73f142c5', course_id: '5d3c81fbaf84df3df0a18c1b', name: 'Homework', weight: 0.15, position: 1}],
	['categories', {id: '5d3c8292be185434819fe939', course_id: '5d3c81fbaf84df3df0a18c1b', name: 'Test 1', weight: 0.20, position: 2}],
	['categories', {id: '5d3c82961fead145ac4e475e', course_id: '5d3c81fbaf84df3df0a18c1b', name: 'Test 2', weight: 0.21, position: 3}],
	['categories', {id: '5d3c829dad5f9593fc7f14d3', course_id: '5d3c81fbaf84df3df0a18c1b', name: 'Test 3', weight: 0.22, position: 4}],
	['categories', {id: '5d3c82a385d1fd7f2800688c', course_id: '5d3c81fbaf84df3df0a18c1b', name: 'Test 4', weight: 0.22, position: 5}],
	['categories', {id: '5d3c9230227f72dc4787f245', course_id: '5d3c8227faade0e6c7e0ed30', name: 'Labs', weight: 0.30, position: 1}],
	['categories', {id: '5d3c923a374d77443c80d43d', course_id: '5d3c8227faade0e6c7e0ed30', name: 'Test 1', weight: 0.40, position: 2}],
	['categories', {id: '5d3c923e2da3b7b3c6bc2532', course_id: '5d3c8227faade0e6c7e0ed30', name: 'Test 2', weight: 0.40, position: 3}],
	['categories', {id: '5d3c92425e51e141ad90ff8d', course_id: '5d3c822b361ac86457c4395e', name: 'Participation', weight: 0.10, position: 1}],
	['categories', {id: '5d3c92466426f4f8e25f04cd', course_id: '5d3c822b361ac86457c4395e', name: 'Quizzes', weight: 0.50, position: 2}],
	['categories', {id: '5d3c924c26491c2612b66c29', course_id: '5d3c822b361ac86457c4395e', name: 'Final Exam', weight: 0.40, position: 3}],
	['categories', {id: '5d3c9251aa114f0a63992119', course_id: '5d3c8230c95745a3e0806c9b', name: 'Paper 1', weight: 0.30, position: 1}],
	['categories', {id: '5d3c925602bd1dae4e44ba0f', course_id: '5d3c8230c95745a3e0806c9b', name: 'Paper 2', weight: 0.35, position: 2}],
	['categories', {id: '5d3c925b3ff7c43c348498cd', course_id: '5d3c8230c95745a3e0806c9b', name: 'Paper 3', weight: 0.35, position: 3}],
