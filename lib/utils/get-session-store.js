...
/** @typedef {import('connect-session-knex')} CSK */
/** @typedef {ReturnType<CSK>} StoreFactory */
/** @typedef {ConstructorParameters<StoreFactory>[0]} ConfigType */

export async function _getStore() {
	/** @type {import('connect-redis').RedisStore | StoreFactory} */
	let Store;
	/** @type {import('connect-redis').RedisStoreOptions | ConfigType} */
	let storeOptions;
