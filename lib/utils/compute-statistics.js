...
const offset = require('./timezone-offset');
 ...
 */
module.exports = async function runStatistics(db = null) {
	const fullDate = date();
	...
	const justDate = (offset > 0) ? fullDate.add(-1, 'day').format('YYYY-MM-DD') : fullDate.format('YYYY-MM-DD');
