...
import {serialize, category} from '../services/serializers/database-response/index.js';
import * as models from '../models/index.js';
import base from './base.js';

const debug = createDebugger('api:category');
const {grade: {create: Grade}, category: {create: Category}} = models;
...
export const api = {
	...
	*/
	async browse(options, db, txn = null) {
		...
		debug('Sending category.browse query with params', {
			joins, joinIn, paramsIn: parametersIn, params: parameters,
		});
