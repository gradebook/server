...
module.exports = async function serve() {
	try {
		...
		const schemaValidator = require('./services/validation/schema-validator');
		...
		// @ts-expect-error init is added to the ajv instance by us
		// NOTE: schemaValidator depends on the settings service to be initialized because some of the validations are
