...
const schema = {
	users: {
		...
		settings: {type: 'text', fallback: '{}'} // @todo: maxLength = 10000
	},
	courses: {
		id: {type: 'string', maxLength: ID_MAXLEN, nullable: false, primary: true, unique: true},
		...
		credit_hours: {type: 'tinyint', nullable: true, fallback: null, unsigned: true}
	},
	categories: {
		id: {type: 'string', maxLength: ID_MAXLEN, nullable: false, primary: true, unique: true},
		...
		dropped_grades: {type: 'tinyint', nullable: true, fallback: null, unsigned: true}
	},
	grades: {
		id: {type: 'string', maxLength: ID_MAXLEN, nullable: false, primary: true, unique: true},
