...
module.exports = {
	...
	courses: {
		...
		cut1Name: {type: 'string', nullable: false, defaultTo: 'A'},
		cut2Name: {type: 'string', nullable: false, defaultTo: 'B'},
		cut3Name: {type: 'string', nullable: false, defaultTo: 'C'},
		cut4Name: {type: 'string', nullable: false, defaultTo: 'D'}
	},
	categories: {
		id: {type: 'string', maxLength: ID_MAXLEN, nullable: false, primary: true, unique: true},
