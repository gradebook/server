const {MAX_CREDITS_IN_COURSE} = require('../services/validation/schema-loader');
...
const schema = {
	...
	courses: {
		...
		credit_hours: {type: 'tinyint', nullable: true, fallback: null, unsigned: true, validations: {between: [0, MAX_CREDITS_IN_COURSE]}},
		settings: {type: 'json', fallback: '{}', validations: {maxLength: 10_000}},
	},
	categories: {
		id: {type: 'string', maxLength: ID_MAX_LEN, nullable: false, primary: true, unique: true},
