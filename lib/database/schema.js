...
module.exports = {
	users: {
		...
		firstName: {type: 'string', maxLength: 100, nullable: false},
		...
		isNew: {type: 'boolean', defaultTo: true}
	},
	courses: {
		id: {type: 'string', maxLength: ID_MAXLEN, nullable: false, primary: true, unique: true},
		// For now, this is a visibility flag, but we're treating this as an int for future use cases
		status: {type: 'integer', nullable: false, defaultTo: 1, oneOf: [0, 1]},
		...
		cutA: {type: 'float', nullable: false, defaultTo: 90},
		cutB: {type: 'float', nullable: false, defaultTo: 80},
		cutC: {type: 'float', nullable: false, defaultTo: 70},
		cutD: {type: 'float', nullable: false, defaultTo: 60}
	},
	categories: {
		id: {type: 'string', maxLength: ID_MAXLEN, nullable: false, primary: true, unique: true},
	...
	statistics: {
		...
		deletedGrades: {type: 'integer', nullable: false},
