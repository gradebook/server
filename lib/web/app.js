...
module.exports.mount = app => {
	...
	app.get('/app', authentication.withUser, home.app);

	// Check if the file exists locally, or forward the request to the frontend
	app.use('/app', express.static(join(__dirname, '../frontend/client/release')), authentication.withUser, home.app);
	...
	app.put('/api/v0/me/approve', wrap(user.approve));
	...
	app.post('/api/v0/category/:id/expand', validation('editCategory'), permission('editCategory'), wrap(category.expand));
