...
module.exports.mount = app => {
	...
	app.put('/api/v0/courses/import', validation('importCourse'), permission('importCourse'), wrap(course.import)); // Import course template
	...
	app.post('/api/v0/category/:id/expand', validation('expandCategory'), permission('expandCategory'), wrap(category.expand));
