...
module.exports.mount = app => {
	...
	app.get('/favicon.ico', (_, res) => res.sendFile(join(viewRoot, './favicon.ico')));
	app.get('/apple-touch-icon.png', (_, res) => res.sendFile(join(viewRoot, './apple-touch-icon.png')));
	app.get('/apple-touch-icon-precomposed.png', (_, res) => res.sendFile(join(viewRoot, './apple-touch-icon.png')));
