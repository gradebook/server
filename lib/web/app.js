...
const {json: jsonMiddleware} = require('express');
...
module.exports.mount = app => {
	...
	const legacyCreateCourse = pipeline({
		permission: 'createCourse',
		validation: 'legacyCreateCourse',
		controller: course.legacyCreate,
		serializer: 'course'
	});

	app.put('/api/v0/courses', legacyCreateCourse);
	app.put('/api/v0/courses/legacy', legacyCreateCourse);
