...
module.exports.mount = app => {
	...
	app.get('/api/v0/me/export-data', pipeline({rateLimit: 'exportData', validation: 'exportData', controller: user.export}));
	...
	app.put('/api/v0/courses/import', pipeline({
		rateLimit: 'importCourse', validation: 'importCourse', controller: course.import
	}));
