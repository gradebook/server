...
module.exports = [{
	...
	function: async function runStatistics() {
		...
		console.log({justDate, totalUsers, newUsers, totalCourses, totalCategories, totalGrades, deletedCourses, deletedCategories, deletedGrades, newUsersLastWeek});

		try {
			const returned = await knex('statistics').insert({date: justDate, totalUsers, newUsers, totalCourses, totalCategories, totalGrades, deletedCourses, deletedCategories, deletedGrades, newUsersLastWeek});
