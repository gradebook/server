...
const buildHead = (theme, schoolConfig) => `
	<link rel="icon" href="https://schools.gradebook.app/api/v1/${schoolConfig.name}/favicon.svg" type="image/svg+xml" />
	<link rel="manifest" href="https://schools.gradebook.app/api/v1/${schoolConfig.name}/manifest.webmanifest" crossorigin="anonymous" />
