...
export const reportAnIssue = new RateLimiter(config.get('rateLimit:reportAnIssue')).mw;
export const syllabus = new RateLimiter(config.get('rateLimit:syllabus')).mw;
