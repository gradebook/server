...
class ThemeService {
	...
	constructor() {
		...
		*/
		...
		this._themes.set('aggie', {primary: '#500000', hover: '#bb0000', name: 'Aggie', background: 'https://static.gradebook.app/sYbR9JXKTI/aggie.jpg'});
		...
		this._themes.set('raider', {primary: '#cc0000', hover: '#ff1919', name: 'Raider', background: 'https://static.gradebook.app/sYbR9JXKTI/raider.jpg'});
