...
class ThemeService {
	constructor() {
		...
		*/
		...
		this._themes.set('default', '{"primary": "#5E3B4D", "hover": "#7e4f67", "siteNickname": "", "imageName": "generic.jpg"}');
		...
		this._themes.set('commodore', '{"primary": "#866d4b", "hover": "#ad926e", "siteNickname": "Commodore", "imageName": ""}');
	...
	*/
	getThemeForHost(hostname) {
		...
		const schoolTheme = JSON.parse(this._themes.get(school));
