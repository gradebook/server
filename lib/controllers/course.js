...
module.exports = {
	...
	create: async (req, res) => {
		...
		const course = await api.course.create({user_id: userID, semester, cutA, cutB, cutC, cutD, name}, req._table);
	...
	async edit(req, res) {
		const response = await api.course.update(req.params.id, req.queriedData, req.body, req._table);
