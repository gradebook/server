...
module.exports = {
	...
	*/
	async create(req, res) {
		const ALL_PROPERTIES = ['id', 'course_id', 'name', 'weight', 'position', 'user_id', 'course_id', 'grade', 'dropped'];
		const apiData = {
	...
	*/
	async contract(req, res) {
		...
		const id = await api.category.contract(category.id, category.grades, grade, req._table);
