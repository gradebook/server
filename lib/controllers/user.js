...
module.exports = {
	/**
	 * @param {import('../../global.d').Request} req
	 * @param {import('../../global.d').ResponseWithContext} res
	 */
	me: (req, res) => {
		const theme = themeService.getThemeForHost(req._domain);
		res.context = {
			statusCode: 200,
			body: Object.assign({theme}, req.session.userProfile || req.user)
		};
